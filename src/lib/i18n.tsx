...
const messages = {
  vi: {
    ...
    rsvpEmailHelp: "Email giúp chúng tôi liên lạc với Quý khách dễ dàng hơn trong tương lai (không bắt buộc).",
    rsvpOther: "Other:",
  ...
  en: {
    ...
    rsvpEmailPlaceholder: "your.email@example.com",
    rsvpEmailHelp: "Your email helps us reach you more easily in the future (optional).",
    rsvpOther: "Other:",
