...
const messages = {
  vi: {
    ...
    hostMailSubject: "Tiêu đề email",
    hostMailBody: "Nội dung thư (sửa trong khung kem)",
    hostMailSubjectPlaceholder: "Thông báo từ Annie & Dũng",
    hostMailBodyPlaceholder:
      "Xin chào {{name}},\n\nAnnie & Dũng trân trọng kính mời quý khách đến dự Lễ Đính Hôn.\n\nRất mong được đón tiếp quý khách.",
    hostMailTemplateLabel: "Mẫu email (xem trước)",
    hostMailTemplateNote:
      "Sửa tiêu đề và nội dung bên dưới. Khung burgundy / kem giống email khách nhận. Dùng {{name}} — xem trước sẽ thay bằng tên mẫu.",
    hostMailSampleGuest: "Nguyễn Văn A",
    hostMailCta: "Mở thiệp mời",
  ...
  en: {
    ...
    hostMailSubject: "Email subject",
    hostMailBody: "Letter body (edit in the cream card)",
    hostMailSubjectPlaceholder: "A note from Annie & Dũng",
    hostMailBodyPlaceholder:
      "Dear {{name}},\n\nAnnie & Dũng warmly invite you to our Engagement Ceremony.\n\nWe hope you can celebrate with us.",
    hostMailTemplateLabel: "Email template (live preview)",
    hostMailTemplateNote:
      "Edit the subject and message below. The burgundy / cream frame matches what guests receive. Use {{name}} — the preview substitutes a sample name.",
    hostMailSampleGuest: "Alex Nguyen",
    hostMailCta: "Open invitation",
